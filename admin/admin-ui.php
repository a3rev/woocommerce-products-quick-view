...
class Admin_UI
{
	...
	public $plugin_prefix = WC_QUICK_VIEW_ULTIMATE_PREFIX;
	...
	public function __construct() {
		$this->google_api_key_option     = WC_QUICK_VIEW_ULTIMATE_KEY . '_google_api_key';
		$this->google_map_api_key_option = WC_QUICK_VIEW_ULTIMATE_KEY . '_google_map_api_key';
		$this->toggle_box_open_option    = WC_QUICK_VIEW_ULTIMATE_KEY . '_toggle_box_open';
		$this->version_transient         = WC_QUICK_VIEW_ULTIMATE_KEY . '_licinfo';

		if ( defined( 'WC_QUICK_VIEW_ULTIMATE_G_FONTS' ) ) {
			$this->is_load_google_fonts = (boolean) WC_QUICK_VIEW_ULTIMATE_G_FONTS;
		}
